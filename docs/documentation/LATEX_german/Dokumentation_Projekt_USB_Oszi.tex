...
\begin{itemize}
    ...
    \item \textbf{Debugging:} Ermöglicht das manuelle Konfigurieren von Abtastfrequenz und Referenzspannung zu Test- und Analysezwecken.
    \item \textbf{General:} Beinhaltet die Hauptbenutzeroberfläche. Hier werden sämtliche grafische Elemente erzeugt und die zugehörige Logik implementiert. Innerhalb dieser Klasse werden die folgenden Komponenten initialisiert:
    \begin{itemize}
        ...
        \item \emph{CustomStepSpinBox} Realisiert benutzerdefinierte Drehregler zur komfortablen Parametereinstellung (nicht im Klassendiagramm dargestellt).
    \end{itemize}
\end{itemize}
...
\subsubsection{Hardwareinterface}
...
\subsubsection{Kommunikation zwischen Hardwareinterface und Benutzeroberfläche}
...
- Umrechnung der Werte vom uC in Spannungswerte
- Plot -> einmal aufbauen nur aktualisiert
- Wie wurden Cursor realisiert
- FSM GUI
- FSM PC
- Erstellen der Threads

\subsubsection{Messfunktionen}
- Implementierung der Messungen (Periode, Dach und Base)
