...
\begin{figure}[H]
	\centering
    \includegraphics[scale=0.4]{rectangle_1Vpp_10kHz_noFilter.png} 
...
\begin{figure}[H]
	\centering
    \includegraphics[scale=0.4]{rectangle_1Vpp_10kHz_Filter_cumulative.png} 
	\caption{\centering Signalverlauf kumulativer gleitender Mittelwertfilter (M=51)\\
	\footnotesize 10kHz Rechtecksignal mit überlagertem Rauschen (1Vpp; Bandbreite: 1MHz)}
\end{figure}

\begin{figure}[H]
	\centering
    \includegraphics[scale=0.4]{rectangle_1Vpp_10kHz_Filter_recursive.png} 
