...
\subsection{Konzept Hardwareinterface}
...
\subsection{Konzept Benutzeroberfläche}
...
Debugfenster beschreiben:\\
 ...
 \begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{GUI_debug_view.png}
	\caption{Debug-Fenster der Benutzeroberfläche}
	\label{fig:debug_Benutzeroberflaeche}
\end{figure}

\subsection{Besonderheiten und Bedienhinweise}
...
\textbf{Zusammenfassend} bietet die GUI des USB-Oszilloskops eine nutzerfreundliche und praxisorientierte Oberfläche mit allen aus einem klassischen Tischoszilloskop bekannten Einstellungsmöglichkeiten, ergänzt um die Darstellung der Zustände.
\pagebreak
