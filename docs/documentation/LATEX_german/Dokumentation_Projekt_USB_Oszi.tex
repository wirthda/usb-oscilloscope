...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{paketdiagramm.png}
...
\subsection{Benutzeroberfläche des USB-Oszilloskops}
\begin{figure}[H]
	\centering
...
\begin{itemize}
    \item Änderungen der Trigger- oder Interpolationsart sind ausschließlich im Idle-Zustand des Mikrocontrollers möglich. Die Messung muss zuvor gestoppt werden.
