...
\emph{Abhängigkeiten:} Dieses Modul verwendet Funktionen aus \texttt{queue.c} zur Event-Verarbeitung
sowie Funktionen aus \texttt{app.c} zur Hardwaresteuerung.\\
...
\subsection{FW-Test}
\subsubsection{Integrierter Debugger}

\pagebreak

\subsubsection{Terminal Programm und Python-Testcode}

\pagebreak

\subsubsection{Gleitender Mittelwertfilters}
...
Den Abbildungen ist zu entnehmen, dass die Anwendung des Filters eine Rauschunterdrückung zur Folge hat. Des Weiteren wird aber auch die Flankensteilheit verringert.
