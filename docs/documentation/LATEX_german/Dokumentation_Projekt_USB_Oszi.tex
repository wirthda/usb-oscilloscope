...
übergeben werden können. Die Kommunikation wurde mit zwei Warteschlangen realisiert, eine dient zur Übergabe von Statusmeldungen von der  PC FSM zur Benutzeroberfläche (GUI) und die andere zur
Übergabe von Befehlen von der GUI an die PC FSM. 
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{Übersichtsschaltbild_Testaufbau.png}
...
\begin{table}[H]
	...
	\hline 
	\emph{H3} (Baugruppe) & +12 V + $U_D$ & \\ 
	\hline 
	\emph{H4} (Baugruppe) & -12 V - $U_D$ & \\ 
	\hline 
...
\begin{footnotesize}
	...
	\begin{itemize}
		\item Aufgrund der eingebauten Verpolungsschutz-Diode ist jeweils eine zusätzliche Spannung von $U_D\approx 0.3\hspace{0.1cm}V$ zu berücksichtigen.
