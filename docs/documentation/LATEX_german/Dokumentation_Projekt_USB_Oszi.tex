...
Durch umfangreiche Bibliotheken wie \emph{numpy}\footnote{\href{https://numpy.org/doc/2.3/}{\emph{numpy}-Dokumentation der verwendeten Version 2.3}} für numerische Auswertung, \emph{matplotlib}\footnote{\href{https://matplotlib.org/3.10.3/index.html}{\emph{matplotlib}-Dokumentation für die verwendete Version 3.10.3}} für die grafische Darstellung der Daten, \emph{pyserial}\footnote{\href{https://pyserial.readthedocs.io/en/latest/pyserial.html}{\emph{pyserial}-Dokumentation (verwendete Version: 3.5)}} für Schnittstellenkommunikation sowie leistungsfähige Frameworks für GUI-Entwicklung wie \emph{PySide6}\footnote{\href{https://doc.qt.io/qtforpython-6/index.html}{\emph{PySide6}-Dokumentation (verwendete Version: 6.9.2)}},
...
\begin{figure}[H]
	...
	\caption{\centering Testsignal: Sinus (f = 1 MHz, $V_{pp}$ = 4 V)\\ \footnotesize Überprüfung mittels Measure-Funktionen}
\end{figure}
...
Man beachte die Top- und Base-Messung, die ist top.
