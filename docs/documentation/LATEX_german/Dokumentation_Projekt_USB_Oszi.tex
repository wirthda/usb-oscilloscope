...
Der zugehörige Schaltplanteil findet sich auf Seite 3 des Schematics im \autoref{sec:appendix_a}.
...
Der zugehörige Schaltplanteil findet sich auf Seite 2 des Schematics im \autoref{sec:appendix_a}.\\
...
Der zugehörige Schaltplanteil findet sich auf Seite 6 des Schematics im \autoref{sec:appendix_a}.
...
Die Daten- und Steuerleitungen des fertiggestellten Interfaceblocks (siehe Seite 4 des Schematics in \autoref{sec:appendix_a}) wurden anschließend gemäß der zuvor vereinbarten Pinbelegung auf die Mikrocontroller-Konnektoren geführt. Die Spannungsversorgung und die Masse wurden an den Konnektoren ebenfalls angeschlossen (siehe Seite 8 des Schematics in \autoref{sec:appendix_a}).
...
Der zugehörige Schaltplanteil findet sich auf Seite 5 des Schematics im \autoref{sec:appendix_a}.
